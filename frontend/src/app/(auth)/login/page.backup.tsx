...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Animated Background */}
      ...
      {/* Header */}
      <header className="relative z-20 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <div className="hidden md:flex items-center space-x-6">
                <Link href="/" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition flex items-center">
                  <HomeIcon className="w-4 h-4 mr-1" />
                  Home
                </Link>
                <Link href="/courses" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition flex items-center">
                ...
                <Link href="/contact" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition flex items-center">
      ...
      <div className="flex-1 flex relative z-10">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100">Expert Teachers</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Learn from the best in the field</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Tailored to your pace and style</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100">Secure & Private</h3>
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8">
              ...
              {/* Quick Login Options */}
              <div className="mb-6">
                <p className="text-sm text-gray-600 dark:text-gray-400 text-center mb-3">Quick login as:</p>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="email"
                      autoComplete="email"
                      className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-12 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              ...
              <div className="mt-8">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    type="button"
                    className="w-full inline-flex justify-center py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-all"
                  >
      ...
      {/* Footer */}
      <footer className="relative z-20 bg-gray-900 dark:bg-gray-950 text-white mt-auto">
